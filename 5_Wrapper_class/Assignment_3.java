...
*/
import java .util.*;
public final class leading0_int_to_binary_8digits {
	public static void main(String[] args) {
		Scanner get_inpt = new Scanner(System.in);
		int main_input = get_inpt.nextInt();
		String output = String.format("%8s",Integer.toBinaryString(main_input)).replace(" ", "0");
